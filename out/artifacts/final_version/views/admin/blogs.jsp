    ...
    <%
        ...
        if(editMethod != null)
        {
            ...
            if(editMethod.equals(Request.DELETE_METHOD))
                url += Admin.DELETE_BLOG_API;
            else if(editMethod.equals(Request.POST_METHOD) || editBlog.equals(Request.PUT_METHOD))
                url += Admin.BLOGS_API;
                                    ...
                                    <tbody>
                                        <c:forEach var="blog" items="${blogList}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td><a href="/user/${blog.user.userId}">${blog.user.fullName}</a> </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="cdat-menu">
                                                        <ul class="dsach-menu"  id="menu-${loop.index}">
                                                            <c:if test="${blog.status == -2 || blog.status == 1}">
                                                                <li>
                                                            ...
                                                            <c:if test="${blog.status == 2 || blog.status == 0}">
                                                                <li>
                                                                    <form>
                                                                        <input type="hidden" name="editBlog" value="POST">
                                                                        <input type="hidden" name="id" value="${blog.blogId}">
                                                            ...
                                                            <c:if test="${USER_MODEL.role == 3}">
                                                                <li>
                                                                    <form>
                                                                        <input type="hidden" name="editBlog" value="DELETE">
                                                                        <input type="hidden" name="id" value="${blog.blogId}">
                                                                        <button>Xóa truyện này</button>
                                                                    </form>
                                                                </li>
                                                            </c:if>
                                                        </ul>
