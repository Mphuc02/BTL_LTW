...
<body>
                    ...
                    <div class="navbar-main">
                        <ul class="navbar__list">
                            <li class="navbar__item">
                                <a href="${categories}" class="navbar__item--link">Quản lý thể loại</a>
                            </li>
                            <li class="navbar__item">
                                <a href="${blogs}" class="navbar__item--link">Quản lý truyện</a>
                            </li>
                            <li class="navbar__item">
                                <a href="#" class="navbar__item--link">Quản lý người dùng</a>
                            </li>
                        </ul>
                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${users_list}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td>
                                                    <a href="/admin/users/edit/${user.userId}">Chỉnh sửa</a>
                                                </td>
                                                <td>
    ...
    <script>
        initPagination('${users}')//Phân trang
